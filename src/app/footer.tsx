    ...
    return (
      <div className="w-full sm:h-[28rem] mt-12 bg-gray-50 backdrop-blur-3xl">
        <div className="text-2xl flex justify-center items-center p-10">
          <Image src="/logo.png" alt="logo" width={100} height={100} style={{width: "auto" , height:"auto"}}/>
        ...
        <div className="text-center m-6 text-sm">
          <p>© {new Date().getFullYear()} by <span className="font-bold sm:text-lg">Urooj Sadiq</span>. All rights reserved.</p>
        </div>
      </div>
    );
  }
